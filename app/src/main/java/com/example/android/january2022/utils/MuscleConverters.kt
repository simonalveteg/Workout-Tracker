...
fun turnTargetIntoMuscleGroup(target: String): String {
    val muscleGroup = when (target.trim().replace("\n", "")) {
        "Sternocleidomastoid", "Splenius" -> MuscleGroup.NECK
        ...
        "Levator Scapulae", "Rhomboids", "Infraspinatus", "Teres Minor", "Subscapularis", "Erector Spinae",
        ...
        "Rectus Abdominis", "Transverse Abdominis", "Obliques" -> MuscleGroup.ABDOMINALS
